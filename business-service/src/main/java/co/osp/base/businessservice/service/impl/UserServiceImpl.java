...
import co.osp.base.businessservice.repository.AuthorityRepository;
import co.osp.base.businessservice.repository.UserRepository;
import co.osp.base.businessservice.utils.SecurityUtils;
import co.osp.base.businessservice.service.UserService;
...
//                this.clearUserCaches(user);
    ...
    private User syncUserWithIdP(Map<String, Object> details, User user) {
        ...
        if (existingUser.isPresent()) {
            if (existingUser.get().getImage() != null && existingUser.get().getImageContentType() != null)
            {
                user.setImage(existingUser.get().getImage());
                user.setImageContentType(existingUser.get().getImageContentType());
            }
